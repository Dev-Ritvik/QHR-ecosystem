// apps/monolith/src/app/(experience)/@modal/(.)about/page.tsx
//
// INTERCEPTED variant — soft navigation to /about from inside the experience.
//
// Next matches (.)about at the same tree depth as the interceptor, which is
...
const PAGE = UTILITY_PAGES['about'];
