// apps/monolith/src/app/(experience)/@modal/(.)branches/page.tsx
//
// INTERCEPTED variant — soft navigation to /branches from inside the experience.
//
// Next matches (.)branches at the same tree depth as the interceptor, which is
...
const PAGE = UTILITY_PAGES['branches'];
