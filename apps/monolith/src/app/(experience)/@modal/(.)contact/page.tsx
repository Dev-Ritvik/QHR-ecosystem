// apps/monolith/src/app/(experience)/@modal/(.)contact/page.tsx
//
// INTERCEPTED variant — soft navigation to /contact from inside the experience.
//
// Next matches (.)contact at the same tree depth as the interceptor, which is
...
const PAGE = UTILITY_PAGES['contact'];
