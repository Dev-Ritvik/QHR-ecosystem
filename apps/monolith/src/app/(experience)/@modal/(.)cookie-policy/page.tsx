// apps/monolith/src/app/(experience)/@modal/(.)cookie-policy/page.tsx
//
// INTERCEPTED variant — soft navigation to /cookie-policy from inside the experience.
//
// Next matches (.)cookie-policy at the same tree depth as the interceptor, which is
...
const PAGE = UTILITY_PAGES['cookie-policy'];
