// apps/monolith/src/app/(experience)/@modal/(.)downloads/page.tsx
//
// INTERCEPTED variant — soft navigation to /downloads from inside the experience.
//
// Next matches (.)downloads at the same tree depth as the interceptor, which is
