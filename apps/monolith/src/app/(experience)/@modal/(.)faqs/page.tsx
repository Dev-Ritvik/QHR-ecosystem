// apps/monolith/src/app/(experience)/@modal/(.)faqs/page.tsx
//
// INTERCEPTED variant — soft navigation to /faqs from inside the experience.
//
// Next matches (.)faqs at the same tree depth as the interceptor, which is
