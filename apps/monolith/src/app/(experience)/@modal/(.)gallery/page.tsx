// apps/monolith/src/app/(experience)/@modal/(.)gallery/page.tsx
//
// INTERCEPTED variant — soft navigation to /gallery from inside the experience.
//
// Next matches (.)gallery at the same tree depth as the interceptor, which is
...
const PAGE = UTILITY_PAGES['gallery'];
