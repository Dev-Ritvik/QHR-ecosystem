// apps/monolith/src/app/(experience)/@modal/(.)knowledge/page.tsx
//
// INTERCEPTED variant — soft navigation to /knowledge from inside the experience.
//
// Next matches (.)knowledge at the same tree depth as the interceptor, which is
...
const PAGE = UTILITY_PAGES['knowledge'];
