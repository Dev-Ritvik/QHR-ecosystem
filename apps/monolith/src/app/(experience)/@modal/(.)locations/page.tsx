// apps/monolith/src/app/(experience)/@modal/(.)locations/page.tsx
//
// INTERCEPTED variant — soft navigation to /locations from inside the experience.
//
// Next matches (.)locations at the same tree depth as the interceptor, which is
...
const PAGE = UTILITY_PAGES['locations'];
