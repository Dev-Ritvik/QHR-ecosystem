// apps/monolith/src/app/(experience)/@modal/(.)privacy/page.tsx
//
// INTERCEPTED variant — soft navigation to /privacy from inside the experience.
//
// Next matches (.)privacy at the same tree depth as the interceptor, which is
...
const PAGE = UTILITY_PAGES['privacy'];
