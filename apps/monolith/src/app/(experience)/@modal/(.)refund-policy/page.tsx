// apps/monolith/src/app/(experience)/@modal/(.)refund-policy/page.tsx
//
// INTERCEPTED variant — soft navigation to /refund-policy from inside the experience.
//
// Next matches (.)refund-policy at the same tree depth as the interceptor, which is
...
const PAGE = UTILITY_PAGES['refund-policy'];
