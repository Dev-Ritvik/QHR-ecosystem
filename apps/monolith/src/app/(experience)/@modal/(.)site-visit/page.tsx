// apps/monolith/src/app/(experience)/@modal/(.)site-visit/page.tsx
//
// INTERCEPTED variant — soft navigation to /site-visit from inside the experience.
//
// Next matches (.)site-visit at the same tree depth as the interceptor, which is
...
const PAGE = UTILITY_PAGES['site-visit'];
