// apps/monolith/src/app/(experience)/@modal/(.)terms/page.tsx
//
// INTERCEPTED variant — soft navigation to /terms from inside the experience.
//
// Next matches (.)terms at the same tree depth as the interceptor, which is
...
const PAGE = UTILITY_PAGES['terms'];
