// apps/monolith/src/app/(experience)/@modal/(.)updates/page.tsx
//
// INTERCEPTED variant — soft navigation to /updates from inside the experience.
//
// Next matches (.)updates at the same tree depth as the interceptor, which is
...
const PAGE = UTILITY_PAGES['updates'];
