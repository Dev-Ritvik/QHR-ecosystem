// apps/monolith/src/app/(experience)/@modal/(.)why-us/page.tsx
//
// INTERCEPTED variant — soft navigation to /why-us from inside the experience.
//
// Next matches (.)why-us at the same tree depth as the interceptor, which is
...
const PAGE = UTILITY_PAGES['why-us'];
