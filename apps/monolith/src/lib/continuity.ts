...
export const TABLE: readonly Keyframe[] = [
  ...
  { q: 0.180, fov: 45.0, ev: -1.05, roll: 0.10, fog: 0.00107, hz: 34, lights: 3, beat: 'I · Scale reveal' },
  { q: 0.250, fov: 41.0, ev: -0.70, roll: 0.00, fog: 0.001, hz: 34, lights: 3, beat: 'I · Settle' },
  { q: 0.320, fov: 42.0, ev: -0.70, roll: 1.30, fog: 0.00095, hz: 34, lights: 3, beat: 'II · Orbit entry' },
  { q: 0.380, fov: 43.0, ev: -0.70, roll: 2.40, fog: 0.0009, hz: 34, lights: 3, beat: 'II · Bank peak' },
  { q: 0.440, fov: 44.0, ev: -0.70, roll: 1.80, fog: 0.00085, hz: 34, lights: 3, beat: 'II · Water reveal' },
  { q: 0.500, fov: 44.0, ev: -0.70, roll: 1.20, fog: 0.0008, hz: 34, lights: 3, beat: 'II · Terminus' },
  { q: 0.580, fov: 44.0, ev: -0.70, roll: 0.50, fog: 0.0007, hz: 34, lights: 4, beat: 'III · Approach' },
  { q: 0.640, fov: 42.0, ev: -0.70, roll: 0.10, fog: 0.0004, hz: 38, lights: 4, beat: 'III · Threshold' },
  ...
  { q: 0.985, fov: 37.0, ev: 0.35, roll: 0.00, fog: 0, hz: 34, lights: 4, beat: 'IV · Severance' },
